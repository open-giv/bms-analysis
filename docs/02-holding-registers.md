...
|-|-|
| 19 | Modify to reg 20 to 0x10 then reg 19 to 0x10 causes inverter discharge rate to drop to approx 10W and inverter status to go 'yellow' in cloud portal.  Setting reg 20 to 0x10 alone appears to have no impact on inverter state. |
